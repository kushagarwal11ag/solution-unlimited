      ...
      <div className="flex flex-col justify-center order-2 lg:order-1">
        <div className="grid gap-2">
          ...
          <p className="text-black/85 dark:text-white/85">
            We deliver comprehensive plumbing services, from installations and
            upgrades to repairs and maintenance. Our skilled team ensures
            efficient, safe, and reliable plumbing systems, addressing issues
            promptly.
          </p>
