        ...
        <div className="grid gap-6 grid-cols-1 lg:grid-cols-2 lg:gap-12">
          <div className="flex flex-col gap-5">
            ...
            <p className="md:text-xl">
              ...
              Welcome to Solution Unlimited, your premier choice for
              comprehensive commercial and industrial services. Founded by Manoj
              Kumar and Mukesh Vaghela, we specialize in electrical, civil, and
              fabrication work, offering seamless, end-to-end solutions.
            </p>
            <Link
              href="#services"
